...
module.exports.getFirebase = function() {
    ...
    if (!process.env.FIREBASE_PRIVATE_KEY) {
        throw new Error('FIREBASE_PRIVATE_KEY is required to initialize Firebase');
    }

    if (!process.env.FIREBASE_DATABASE_URL) {
        throw new Error('FIREBASE_DATABASE_URL is required to initialize Firebase');
    }
...
module.exports.getCollection = function(collectionName, sortField, done) {
    ...
    var _collection = exports.getFirebase().ref(collectionName);
