...
function setupListeners() {
  const deploymentCollection = getDatabase().ref("deployment");
  ...
  deploymentCollection.on("child_changed", () => {
    refreshKeys();
  });
}

function refreshKeys() {
  updateKeys({ accessToken: process.env.ACCESS_TOKEN });
}
...
module.exports = { refreshKeys, start };
